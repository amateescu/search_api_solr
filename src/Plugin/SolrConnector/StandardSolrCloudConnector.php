...
class StandardSolrCloudConnector extends StandardSolrConnector implements SolrCloudConnectorInterface {
  ...
  public function defaultConfiguration() {
    return [
      ...
      'stats_cache' => 'org.apache.solr.search.stats.ExactStatsCache',
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['advanced']['stats_cache'] = [
      ...
      '#default_value' => isset($this->configuration['stats_cache']) ? $this->configuration['stats_cache'] : 'org.apache.solr.search.stats.ExactStatsCache',
    ];
