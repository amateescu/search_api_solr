  ...
  protected function alterSolrResponseBody(&$body, QueryInterface $query) {
    ...
    if (isset($data->response)) {
      foreach ($data->response->docs as $doc) {
        $language_id = $doc_languages[$this->createId($this->getTargetedSiteHash($index), $this->getTargetedIndexId($index), $doc->{$field_names['search_api_id']})] = $doc->{$field_names[SEARCH_API_LANGUAGE_FIELD_NAME]};
